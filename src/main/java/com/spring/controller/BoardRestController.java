...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@RequestMapping(value = "/board2/{bbsID}", method = RequestMethod.GET)
	public Map<String, Object> detailBoard(@PathVariable int bbsID) {
		Map<String, Object> result = new HashMap<>();
		BoardVO vo = boardservice.viewBoard(bbsID);
		result.put("list", vo);
		result.put("result", Boolean.TRUE);
		return result;
	}
